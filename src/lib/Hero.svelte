  ...
  <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-10">
    ...
    <div class="mt-5 max-w-2xl text-center mx-auto">
      <h1 class="block font-bold text-gray-800 text-4xl md:text-5xl lg:text-6xl">
        From Assistant to <span class="bg-clip-text bg-gradient-to-tl from-blue-600 to-violet-600 text-transparent">Ally</span> Elevate Your Productivity
      </h1>
    </div>
    <!-- End Title -->

    <div class="mt-5 max-w-3xl text-center mx-auto">
      <p class="text-lg text-gray-600">Don't Just Delegate. Collaborate. Get insights, proactive support, and a true productivity partner.</p>
    </div>
