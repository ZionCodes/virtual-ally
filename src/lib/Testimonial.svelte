...
<div class="relative max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
    ...
    <blockquote class="text-center lg:mx-auto lg:w-3/5">
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="mx-auto w-20 h-auto sm:w-28 text-gray-800"><path d="M7 10v12"/><path d="M15 5.88 14 10h5.83a2 2 0 0 1 1.92 2.56l-2.33 8A2 2 0 0 1 17.5 22H4a2 2 0 0 1-2-2v-8a2 2 0 0 1 2-2h2.76a2 2 0 0 0 1.79-1.11L12 2a3.13 3.13 0 0 1 3 3.88Z"/></svg>
      ...
      <div class="mt-6 lg:mt-10">
        <p class="relative text-xl sm:text-2xl md:text-3xl md:leading-normal font-medium text-gray-800">
          ...
          <span class="relative z-10 italic text-gray-800">You are working at a good pace for the team, doing a great job.</span>
        </p>
      </div>
  
      <footer class="mt-6">
        <div class="font-semibold text-gray-800">Miquel</div>
        <div class="text-sm text-gray-500">CEO | First Class Citizen</div>
      </footer>
    </blockquote>
    <!-- End Blockquote -->
  </div>
